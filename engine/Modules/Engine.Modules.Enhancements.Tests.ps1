...
function TestCaseSetup()
{
    ...
    {    
        New-Item -Force -Path $TestPath -Type Directory | out-null
...
Describe "Engine Modules Enhancements Test" -Tags "Innerloop" {
...
New-Variable -Name isExecuted -Value 100 -Scope Global -Force
