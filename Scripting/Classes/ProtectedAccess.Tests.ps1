...
Describe "Protected Member Access - w/ default ctor" {
...
Describe "Protected Member Access - w/ non-default ctor" {
...
Describe "Protected Member Access - members not visible outside class" {
    Set-StrictMode -v 3
