Describe "FileSystem Provider Tests" -tags InnerLoop {
...
Describe "Function provider tests" -tags InnerLoop {
...
Describe "Registry Provider Tests" -tags InnerLoop,Registry {
